    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5 mb-4">
            <div class="col-md-8 text-center">
                ...
                <p class="text-muted">
                    Please log in to access your account and explore personalized features. If you don’t have an
                    account, you can <a href="<?= site_url('register'); ?>" class="font-weight-bold">Register here</a>.
                </p>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-footer text-center">
                        <p>
                            <a href="<?= site_url('auth/forgot_password'); ?>" class="text-muted">Forgot your
                                password?</a>
                        </p>
                        <p>
